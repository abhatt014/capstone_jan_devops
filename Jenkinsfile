        ...
        stage('Check CI Skip') {
            steps {
                script {
                    ...
                    // If the commit message contains [skip ci], halt the pipeline..... 
                    if (commitMsg.contains('[skip ci]')) {
                        currentBuild.result = 'NOT_BUILT' // Marks it gray/aborted instead of red
                        error('Pipeline halted: This commit was automatically generated by Jenkins.')
                    }
                }
            }        
        stage('build') {
